...
class Tptemp extends React.Component{
    ...
    render() {
        ...
        return <React.Fragment>
            <Column2 
            left={<TemperatureInput scale="c" temperature={celcius} onChangeTemperature={this.handleCelciusChange} />}
            right={<TemperatureInput scale="f" temperature={fahrenhit} onChangeTemperature={this.handleFahrenheitChange} />}
            />
